...
`, o, a, 0.5, r);
  ...
  function bb() {
    ...
    const s = document.createElement("div");
    s.style.display = "flex", s.style.alignItems = "center", lo = document.createElement("button"), lo.textContent = "\u2715", Gs(lo), s.appendChild(lo), n.appendChild(i), n.appendChild(s), ot.appendChild(n), Bi = document.createElement("iframe"), Bi.src = "website/index.html", Ws(Bi, {
      backgroundColor: "rgba(0, 0, 0, 0.0)"
