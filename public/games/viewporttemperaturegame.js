/**
 * Temperature Game Viewport Module
 * 
 * This module handles loading the temperature-game.html content in an iframe
...
/**
 * Creates and shows the temperature game viewport with futuristic animations.
 */
export function showTemperatureGameViewport() {
    ...
    viewportContainer.style.border = '2px solid #FF4500';
    viewportContainer.style.borderRadius = '10px';
    viewportContainer.style.boxShadow = '0 0 20px rgba(255, 69, 0, 0.5)';
    ...
    iframe.src = './website/js/temperature-game.html';
...
/**
 * Hides the temperature game viewport with closing animation.
 */
