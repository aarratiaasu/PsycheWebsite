...
import { showEscapeVelocityViewport, hideEscapeVelocityViewport } from './viewportescapevelocity.js';
...
export function loadSection9(scene, camera) {
    ...
    escapeVelocityButton = new THREE.Mesh(buttonGeometry, buttonMaterial);
    ...
    // Initially hide all section 9 elements
